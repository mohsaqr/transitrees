...
#'     (mirrors \code{predict.transitiontrees()}).
#' }
#'
...
#'
#' @description
#' Returns a new \code{transitiontrees} containing only the queried node and
...
#'
#' @return A new \code{transitiontrees} whose nodes and edges are restricted
