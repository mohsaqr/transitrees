...
re-export or re-format your data: `context_tree()` accepts a fitted
state-sequence or transition/network object **directly**, auto-detected by
its S3 class. It reads the sequences the object already carries and fits the
suffix tree on exactly those, over the same state set.
